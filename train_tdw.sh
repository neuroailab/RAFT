...
mkdir -p checkpoints
# 2.9.22
python -u train.py --name raft-tdw-bs1-tr0-8 --stage tdw --validation chairs --gpus 0 --num_steps 20000 --batch_size 1 --lr 0.0004 --image_size 496 496 --wdecay 0.0001 --filepattern *[0-8] --small
