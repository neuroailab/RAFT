...
mkdir -p checkpoints
# 2.17.22
python -u train.py --name centroid-davisTr-selfsup-ccs-bs4 --stage davis --validation z --gpus 0 1 2 3 --num_steps 100000 --batch_size 4 --lr 0.0004 --image_size 270 480 --wdecay 0.0001 --scale_centroids --model centroid --train_split train --flow_gap 1
