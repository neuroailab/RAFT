...
mkdir -p checkpoints
# 3.10.22
python -u train.py --name occlusion-tdw-bs8-small-20frames-fullplay-tr0-8 --stage tdw --validation z --gpus 0 1 --num_steps 100000 --batch_size 8 --lr 0.0004 --image_size 496 496 --wdecay 0.0001 --model occlusion --small --no_aug --max_frame 25 --full_playroom --filepattern *[0-8]
# 2.27.22
