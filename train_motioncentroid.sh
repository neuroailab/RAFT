...
mkdir -p checkpoints
# 3.10.22
python -u train.py --name mocentroid-tdw-bs8-fullplay-tr0-8 --stage tdw --validation z --gpus 0 1 2 3 --num_steps 100000 --batch_size 8 --lr 0.0004 --image_size 496 496 --wdecay 0.0001 --model motion_centroid --no_aug --full_playroom --filepattern *[0-8] --scale_centroids
# 2.27.22
